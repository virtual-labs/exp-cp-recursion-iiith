...
function step_power(n, stackDepth) {
    ...
    if (eval(`"use strict";n ${basecaseOperator} ${basecase}`)) {
        ...
        const subsol = step_power(eval(`"use strict";${recursecase}`), stackDepth + 1);
...
function check_result(result) {
    if (result === power(variable, maxStackDepth)) {
...
nextButton.addEventListener('click', function () {
    ...
    stackHTML = step_power(maxStackDepth, 1);
